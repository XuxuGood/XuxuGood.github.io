!function (e, t) {
    ...
    return function (e) {
        ...
        var w = n(0).FilterCSS, k = n(0).getDefaultWhiteList, A = n(1), S = new w, _ = /</g, z = />/g, C = /"/g,
            T = /&quot;/g, L = /&#([a-zA-Z0-9]*);?/gim, q = /&colon;?/gim, I = /&newline;?/gim,
            $ = /((j\s*a\s*v\s*a|v\s*b|l\s*i\s*v\s*e)\s*s\s*c\s*r\s*i\s*p\s*t\s*|m\s*o\s*c\s*h\s*a)\:/gi,
            R = /e\s*x\s*p\s*r\s*e\s*s\s*s\s*i\s*o\s*n\s*\(.*/gi, E = /u\s*r\s*l\s*\(.*/gi, j = /<!--[\s\S]*?-->/g;
        ...
        function o(e, t, n) {
            "user strict";
            var o = "", a = 0, s = !1, l = !1, c = 0, u = e.length, p = "", d = "";
            for (c = 0; c < u; c++) {
                var h = e.charAt(c);
                if (!1 === s) {
                    if ("<" === h) {
        ...
        (function (t) {
            !function (t) {
                ...
                function n(e) {
                    this.tokens = [], this.tokens.links = Object.create(null), this.options = e || b.defaults, this.rules = y.normal, this.options.pedantic ? this.rules = y.pedantic : this.options.gfm && (this.options.tables ? this.rules = y.tables : this.rules = y.gfm)
                }
                ...
                function d(e, t) {
                    return w[" " + e] || (/^[^:]+:\/*[^\/]*$/.test(e) ? w[" " + e] = e + "/" : w[" " + e] = m(e, "/", !0)), e = w[" " + e], "//" === t.slice(0, 2) ? e.replace(/:[\s\S]*/, ":") + t : "/" === t.charAt(0) ? e.replace(/(:\/*[^\/]*)[\s\S]*/, "$1") + t : e + t
                }
                ...
                y._label = /(?!\s*\])(?:\\[\[\]]|[^\[\]])+/, y._title = /(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/, y.def = u(y.def).replace("label", y._label).replace("title", y._title).getRegex(), y.bullet = /(?:[*+-]|\d{1,9}\.)/, y.item = /^( *)(bull) ?[^\n]*(?:\n(?!\1bull ?)[^\n]*)*/, y.item = u(y.item, "gm").replace(/bull/g, y.bullet).getRegex(), y.list = u(y.list).replace(/bull/g, y.bullet).replace("hr", "\\n+(?=\\1?(?:(?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$))").replace("def", "\\n+(?=" + y.def.source + ")").getRegex(), y._tag = "address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|section|source|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul", y._comment = /<!--(?!-?>)[\s\S]*?-->/, y.html = u(y.html, "i").replace("comment", y._comment).replace("tag", y._tag).replace("attribute", / +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(), y.paragraph = u(y.paragraph).replace("hr", y.hr).replace("heading", y.heading).replace("lheading", y.lheading).replace("tag", y._tag).getRegex(), y.blockquote = u(y.blockquote).replace("paragraph", y.paragraph).getRegex(), y.normal = f({}, y), y.gfm = f({}, y.normal, {
                    ...
                    e = e.replace(/^ +$/gm, "");
                    for (var n, r, i, o, a, s, l, c, u, p, d, h, f, v, b, x; e;) if ((i = this.rules.newline.exec(e)) && (e = e.substring(i[0].length), i[0].length > 1 && this.tokens.push({type: "space"})), i = this.rules.code.exec(e)) e = e.substring(i[0].length), i = i[0].replace(/^ {4}/gm, ""), this.tokens.push({
                        type: "code",
                ...
                x._punctuation = "!\"#$%&'()*+,\\-./:;<=>?@\\[^_{|}~", x.em = u(x.em).replace(/punctuation/g, x._punctuation).getRegex(), x._escapes = /\\([!"#$%&'()*+,\-.\/:;<=>?@\[\]\\^_`{|}~])/g, x._scheme = /[a-zA-Z][a-zA-Z0-9+.-]{1,31}/, x._email = /[a-zA-Z0-9.!#$%&'*+\/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/, x.autolink = u(x.autolink).replace("scheme", x._scheme).replace("email", x._email).getRegex(), x._attribute = /\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/, x.tag = u(x.tag).replace("comment", y._comment).replace("attribute", x._attribute).getRegex(), x._label = /(?:\[[^\[\]]*\]|\\[\[\]]?|`[^`]*`|[^\[\]\\])*?/, x._href = /\s*(<(?:\\[<>]?|[^\s<>\\])*>|[^\s\x00-\x1f]*)/, x._title = /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/, x.link = u(x.link).replace("label", x._label).replace("href", x._href).replace("title", x._title).getRegex(), x.reflink = u(x.reflink).replace("label", x._label).getRegex(), x.normal = f({}, x), x.pedantic = f({}, x.normal, {
                    ...
                    for (var t, n, i, o, a, s, c = ""; e;) if (a = this.rules.escape.exec(e)) e = e.substring(a[0].length), c += l(a[1]); else if (a = this.rules.tag.exec(e)) !this.inLink && /^<a /i.test(a[0]) ? this.inLink = !0 : this.inLink && /^<\/a>/i.test(a[0]) && (this.inLink = !1), !this.inRawBlock && /^<(pre|code|kbd|script)(\s|>)/i.test(a[0]) ? this.inRawBlock = !0 : this.inRawBlock && /^<\/(pre|code|kbd|script)(\s|>)/i.test(a[0]) && (this.inRawBlock = !1), e = e.substring(a[0].length), c += this.options.sanitize ? this.options.sanitizer ? this.options.sanitizer(a[0]) : l(a[0]) : a[0]; else if (a = this.rules.link.exec(e)) {
                        ...
                        if (a = this.rules.text.exec(e)) e = e.substring(a[0].length), this.inRawBlock ? c += this.renderer.text(a[0]) : c += this.renderer.text(l(this.smartypants(a[0]))); else if (e) throw new Error("Infinite loop on byte: " + e.charCodeAt(0))
                    } else {
                        if ("@" === a[2]) n = l(a[0]), i = "mailto:" + n; else {
                            do {
                    ...
                    var n = t.href, r = t.title ? l(t.title) : null;
                    ...
                    this.inline = new r(e.links, this.options), this.inlineText = new r(e.links, f({}, this.options, {renderer: new o})), this.tokens = e.reverse();
        ...
        (function (t) {
            ...
            function r(e) {
                return function (t) {
                    var r = Array.prototype.slice.call(arguments, 1), i = 0, o = "UNDEFINED";
                    return t.replace(/([{}])\1|[{](.*?)(?:!(.+?))?[}]/g, function (t, a, s, l) {
                        ...
                        var u = c.split("."), p = (/^\d+$/.test(u[0]) ? u : ["0"].concat(u)).reduce(function (e, t) {
        ...
        n(9);
        var o = n(7), a = n(10), s = n(6), l = n(8), c = {
            "zh-cn": {
                nick: "昵称",
                mail: "邮箱",
                link: "网站 (可选)",
                no_comment_yet: "在评论的无人区，留下我的痕迹~",
                submit: "提交",
                reply: "回复",
                cancel_reply: "取消回复",
            ...
            pin: 0
        }, p = !1, d = 3, h = 6, f = {}.toString, g = localStorage, m = function () {
            function e(t) {
                r(this, e);
                var n = this;
            ...
            return i(e, [{
                key: "init", value: function (e) {
                    ...
                    try {
                        ...
                        var m = t.el.querySelector(".vsmile-icons"), b = e.emoticon_list || [];
                        for (var y in b) {
                    ...
                    t.alert = {
                        show: function (e) {
                            ...
                            if (n.innerHTML = "" + r + (e.type && i), _.querySelector(".vcancel").addEventListener("click", function (e) {
                                t.alert.hide()
                ...
                key: "bind", value: function (e) {
                    var t = this, n = t.el.querySelector(".vsmile-icons");
                    v.on("click", n, function (e) {
                        var n = t.el.querySelector(".veditor"), r = e.target.src;
                        if (void 0 !== r) {
                            var i = "!(:" + decodeURI(r).replace(/^.*\/(.*)$/, "$1") + ":)";
                            if (document.selection) n.focus(), sel = document.selection.createRange(), sel.text = i, n.focus(); else if (n.selectionStart || "0" == n.selectionStart) {
                                var o = n.selectionStart, a = n.selectionEnd, s = a;
                    ...
                    var i = function (e) {
                        ...
                        t.loading.show(), t.v.Query.doCloudQuery("select nick, comment, link, rid, emailHash, isSpam\n                                                   from Comment\n                                                   where (rid='' or rid is not exists) and (url='" + u.url + "' or url='" + u.url + "/')\n                                                   order by -createdAt\n                                                   limit " + (n - 1) * h + "," + h).then(function (r) {
                            ...
                            var i = r.length;
                            if (i) {
                                for (var o = 0; o < i; o++) if (!r[o].get("isSpam")) {
                    ...
                    var f = function e(n) {
                        var r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 1,
                            i = n.querySelector(".vcomment-children"), o = i.querySelector(".vlist"),
                            a = n.getAttribute("id");
                        ...
                        t.v.Query.doCloudQuery("select nick, comment, link, rid, emailHash, isSpam\n                           from Comment\n                           where rid='" + a + "' and (url='" + u.url + "' or url='" + u.url + "/')\n                           order by -createdAt").then(function (t) {
                            t = t && t.results || [];
                            var n = t.length;
                            if (n) for (var i = 0; i < n; i++) if (!t[i].get("isSpam")) {
                                var a = m(t[i], o, !0);
                                e(a, r + 1)
                            }
                        }).catch(function (e) {
                        ...
                        var a = e.get("emailHash"),
                            s = "https://gravatar.loli.net/avatar/" + a + "?size=80&d=https://www.liaofuzhan.com/images/head.jpg%3fsize%3d80";
                        ...
                        return i(f), $(o), o
                    }, x = {veditor: "comment", vnick: "nick", vlink: "link", vmail: "mail"}, w = {};
                    for (var k in x) x.hasOwnProperty(k) && function () {
                        var e = x[k], n = t.el.querySelector("." + k);
                    ...
                    var A = function () {
                        ...
                        if (e) {
                            ...
                            if ("" != e.mail) {
                                t.el.querySelector(".visitor_avatar").setAttribute("src", "https://gravatar.loli.net/avatar/" + s(e.mail.toLowerCase().trim()) + "?size=80&d=https://www.liaofuzhan.com/images/head.jpg%3fsize%3d80")
                            }
                        }
                    };
                    A(), t.reset = function () {
                        for (var e in x) if (x.hasOwnProperty(e)) {
                            var n = x[e], r = t.el.querySelector("." + e);
                            r.value = "", u[n] = ""
                        }
                    ...
                    var S = t.el.querySelector(".vsubmit"), _ = function (n) {
                        ...
                        var i = b.mail(u.mail), s = b.link(u.link);
                        u.mail = i.k ? i.v : "", u.link = s.k ? s.v : "", i.k && s.k ? I() : t.alert.show({
                            type: 0,
                            text: t.i18n.input_tips,
                            ctxt: t.i18n.confirm
                        })
                    }, z = t.el.querySelector(".vemoji-btn"), C = t.el.querySelector(".vsmile-icons");
                    v.on("click", z, function (e) {
                        L.getAttribute("triggered") && (L.setAttribute("style", "display:none;"), L.removeAttribute("triggered")), C.getAttribute("triggered") ? (C.setAttribute("style", "display:none;"), C.removeAttribute("triggered")) : (C.removeAttribute("style"), C.setAttribute("triggered", 1))
                    });
                    var T = t.el.querySelector(".vpreview-btn"), L = t.el.querySelector(".vpreview-text");
                    v.on("click", T, function (t) {
                        if (C.getAttribute("triggered") && (C.setAttribute("style", "display:none;"), C.removeAttribute("triggered")), L.getAttribute("triggered")) L.setAttribute("style", "display:none;"), L.removeAttribute("triggered"); else {
                            if ("" == u.comment) return void w.comment.focus();
                    ...
                    var q = function () {
                        ...
                        var e = t.v.Object.extend("Comment"), n = new e;
                        ...
                        n.set("emailHash", s(u.mail.toLowerCase().trim())), n.setACL(q()), n.save().then(function (e) {
                            ...
                            if (n.innerText = Number(n.innerText) + 1, "" === u.rid) m(e, null, !0); else {
                        ...
                        var n = e.getAttribute("id"), r = e.querySelector("#at-" + n);
                        v.on("click", r, function (i) {
                            var o = r.getAttribute("at"), a = r.getAttribute("rid");
            ...
            mail: function (e) {
                return {k: /\w[-\w.+]*@([A-Za-z0-9][-A-Za-z0-9]+\.)+[A-Za-z]{2,14}/.test(e), v: e}
            }, link: function (e) {
            ...
            try {
                var n = e.getTime(), r = (new Date).getTime(), i = r - n, o = Math.floor(i / 864e5);
                if (0 === o) {
        ...
        o.prototype.process = function (e) {
            ...
            var t = this, n = t.options, i = n.whiteList, o = n.onAttr, a = n.onIgnoreAttr, l = n.safeAttrValue;
        ...
        function r(e, t) {
            function n() {
                if (!o) {
                    var n = i.trim(e.slice(a, s)), r = n.indexOf(":");
                    if (-1 !== r) {
                        var c = i.trim(n.slice(0, r)), u = i.trim(n.slice(r + 1));
                        if (c) {
        ...
        var s = n(0).FilterCSS, l = n(4), c = n(5), u = c.parseTag, p = c.parseAttr, d = n(1);
        a.prototype.process = function (e) {
            if (e = e || "", !(e = e.toString())) return "";
            var t = this, n = t.options, o = n.whiteList, a = n.onTag, s = n.onIgnoreTag, c = n.onTagAttr,
                h = n.onIgnoreTagAttr, f = n.safeAttrValue, g = n.escapeHtml, m = t.cssFilter;
            ...
            var b = u(e, function (e, t, n, l, u) {
                var v = {sourcePosition: e, position: t, isClosing: u, isWhite: o.hasOwnProperty(n)}, b = a(n, l, v);
                if (!r(b)) return b;
                if (v.isWhite) {
                    if (v.isClosing) return "</" + n + ">";
                    var y = i(l), x = o[n], w = p(y.html, function (e, t) {
                        var i = -1 !== d.indexOf(x, e), o = c(n, e, t, i);
                        if (!r(o)) return o;
